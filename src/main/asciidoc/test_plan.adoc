...
|I-30 | UC420 | Mitarbeiter ist eingeloggt | Ein Möbelstück wird bestellt und der Einkaufsbetrag des dazugehörigen Lieferanten beträgt 0€ | In der Monatsstatistik wird der Preis des Möbelstücks als Einkaufsbetrag des Lieferanten angezeigt
