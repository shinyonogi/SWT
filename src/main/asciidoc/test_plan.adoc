...
|I-30 | UC420 | Mitarbeiter ist eingeloggt und der Einkaufsbetrag des dazugehörigen Lieferanten beträgt 0€  | Ein Möbelstück desselben Lieferanten wird bestellt | In der Monatsstatistik wird der Preis des Möbelstücks als Einkaufsbetrag des Lieferanten angezeigt
