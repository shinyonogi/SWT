...
| U-07 | Calendar.removeEntry(CalendarEntry) | Kalender besitzt einen Eintrag am Freitag | Der Nutzer möchte den Eintrag vom Freitag entfernen | Der Eintrag wird entfernt
| U-08 | Calendar.removeEntry(CalendarEntry) | Kalender besitzt derzeit keine Einträge | Nutzer möchte Eintrag am Mittwoch entfernen | Entfernen nicht möglich, da der Eintrag nicht vorhanden ist
