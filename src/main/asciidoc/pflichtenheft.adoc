...
image::./images/top_level_architecture.png[Top-Level-Architektur,100%,100%,pdfwidth=100%,title= "Tpp-Level-Architektur des Projektes {project_name}",align=center]
...
|Login                  | Mitarbeiter/Admin haben die Möglichkeit sich einzuloggen und Bestellungen bearbeiten, Möbelgeschäft verwalten etc.
|Mieteintrag            | {domain_ref}
|Mitarbeiter            | Mitarbeiter der Firma "Möbel-Hier".
|Möbelgeschäft          | Zentrale Klasse des Systems.
|Set                    | {domain_ref}
