...
public class ItemDataInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		items.add(new Piece(2, "Classic", Money.of(49.99, Currencies.EURO), "chair_3_black.jpg", "schwarz holz",
				"Classic in schwarz mit Kunstleder und Eichenholz. Der Classic-Stuhl ist ein Allrounder und passt mit seinen neutralen Farben in jedes Zimmer.", stuehleSupplier, 7, Category.CHAIR));

		items.add(new Piece(2, "Classic", Money.of(49.99, Currencies.EURO), "chair_3_white.jpg", "weiß holz",
				"Classic in weiß mit Kunstleder und Eichenholz. Der Classic-Stuhl ist ein Allrounder und passt mit seinen neutralen Farben in jedes Zimmer.", stuehleSupplier, 7, Category.CHAIR));
		...
		items.add(new Piece(10, "Basic+", Money.of(49.99, Currencies.EURO), "chair_2.jpg", "schwarz akazienholz",
				"BasicPlus in schwarz mit Akazienholz und Armlehnen für einen edlen Look. Der BasicPlus-Stuhl eignet sich gut als Küchenstuhl, da er sehr schlicht ist und eine spezielle wasserabweisende Beschichtung besitzt.", stuehleSupplier, 7, Category.CHAIR));

		items.add(new Piece(3, "Tropic", Money.of(89.99, Currencies.EURO), "chair_4.jpg", "blau palisander",
				"Tropic mit blauem Lederpolster und edlem Palisanderholz. Der Tropic-Stuhl eignet sich gut als Küchen- oder Wohnzimmerstuhl, um einen Kaffee mit alten Freunden zu genießen.", stuehleSupplier, 7, Category.CHAIR));

		items.add(new Piece(5, "Savanna", Money.of(89.99, Currencies.EURO), "chair_6.jpg", "beige balsaholz",
				"Savanna mit beigen Balsaholz. Der Savanna-Stuhl wurde den Farben der Savanne nachempfunden und ist ein Platz der Erholung. Er eignet sich gut für das Wohnzimmer.", stuehleSupplier, 8, Category.CHAIR));

		Piece chair_7 = new Piece(6, "Comfort", Money.of(99.99, Currencies.EURO), "chair_7.jpg", "grau stoff",
				"Comfort mit grauem Polster und Fußablage. Der Comfort-Sessel ist der Platz zum Abschalten nach der Arbeit.", stuehleSupplier, 10, Category.CHAIR);
		...
		items.add(new Piece(11, "Designer", Money.of(129.99, Currencies.EURO), "chair_11.jpg", "navy leder",
				"Designer mit blau gefärbtem Echtleder und Akazienholz. Der Designer-Stuhl ist ein hochwertiger aber schlicht gehaltener Stuhl.", stuehleSupplier, 6, Category.CHAIR));

		items.add(new Piece(8, "Oldtimer", Money.of(119.99, Currencies.EURO), "chair_9.jpg", "braun leder",
				"Oldtimer mit Lederbezug. Der Oldtimer-Stuhl zeichnet sich durch seine extrem gute Polsterung aus, welche auch nach dem schwersten Tag ein federleichtes Gefühl vermittelt.", stuehleSupplier, 10, Category.CHAIR));

		items.add(new Piece(4, "Focus", Money.of(149.99, Currencies.EURO), "chair_5.jpg", "schwarz leder",
				"Focus mit schwarzem Leder. Der Focus-Sessel schafft durch seine einzigartige Form eine eigene Welt, um Bücher, Musik oder Filme noch mehr genießen zu können.", stuehleSupplier, 20, Category.CHAIR));

		//add couches
		items.add(new Piece(23, "Classic", Money.of(799.99, Currencies.EURO), "sofa_4.jpg", "weiß stoff",
				"Classic in weiß. Die Classic-Couch ist ein Allrounder, dem es an nichts fehlt. Sie hat ein schlichtes, aber elegantes Design, gute Polster und Platz bis für 4 Leute.", muellerSupplier, 60, Category.COUCH));

		Piece sofa_8 = new Piece(27, "Basic", Money.of(399.99, Currencies.EURO), "sofa_8.jpg", "grau stoff",
				"Basic in grau. Die Basic-Couch ist das Einsteigermodell in die Welt der Sofas. Sie bietet Platz für zwei Personen.", muellerSupplier, 40, Category.COUCH);
		...
		items.add(new Piece(22, "Vintage", Money.of(999.99, Currencies.EURO), "sofa_3.jpg", "braun leder",
				"Vintage mit hellem Leder. Die Vintage-Couch sieht nicht nur cool aus, sondern besitzt auch besonders weiche Polster.", muellerSupplier, 55, Category.COUCH));

		items.add(new Piece(25, "Oldtimer", Money.of(899.99, Currencies.EURO), "sofa_6.jpg", "braun leder",
				"Oldtimer mit Leder. Die Oldtimer-Couch zeichnet sich durch ihre extrem gute Polsterung und ihren Vintage Look aus.", muellerSupplier, 70, Category.COUCH));

		items.add(new Piece(21, "Prestige", Money.of(1499.99, Currencies.EURO), "sofa_2_black.jpg", "schwarz leder",
				"Prestige mit schwarzem Leder. Die Prestige-Couch aus edlem Echtleder bietet zahlreiche Funktionen, wie verstellbare Kopflehnen.", muellerSupplier, 130, Category.COUCH));

		items.add(new Piece(21, "Prestige", Money.of(1499.99, Currencies.EURO), "sofa_2_brown.jpg", "braun leder",
				"Prestige mit braunem Leder. Die Prestige-Couch aus edlem Echtleder bietet zahlreiche Funktionen, wie verstellbare Kopflehnen.", muellerSupplier, 130, Category.COUCH));

		items.add(new Piece(26, "Prestige-Comfort", Money.of(1699.99, Currencies.EURO), "sofa_7.jpg", "weiß",
				"Prestige-Comfort in weiß. Die Prestige-Comfort-Couch kommt mit extra weichen Lehnen und Kissen und bietet wie die Prestige-Couch ausreichend Platz.", muellerSupplier, 120, Category.COUCH));

		//add tables
		items.add(new Piece(38, "Classic", Money.of(479.99, Currencies.EURO), "table_10.jpg", "Eichenholz",
				"Classic aus Eichenholz. Der Classic-Tisch, welcher nur aus Eichenholz besteht, ist das Standardmodell, und gibt dem Raum eine natürliche Note. Er bietet ausreichend Platz für die ganze Familie.", moebelSupplier, 25, Category.TABLE));

		Piece table_9 = new Piece(37, "Basic", Money.of(49.99, Currencies.EURO), "table_9.jpg", "schwarz",
				"Basic mit schwarzer quadratischer Tischplatte. Der Basic-Tisch eignet sich für ein bis zwei Personen.", moebelSupplier, 8, Category.TABLE);

		items.add(table_9);

		Piece table_7 = new Piece(35, "Basic+", Money.of(54.99, Currencies.EURO), "table_7.jpg", "weiß",
				"Basic+ mit weißer runder Tischplatte. Der BasicPlus-Tisch bietet mehr Fläche als der Basic-Tisch und eignet sich für bis zu 3 Personen.", moebelSupplier, 10, Category.TABLE);

		items.add(table_7);

		items.add(new Piece(30, "Focus", Money.of(119.99, Currencies.EURO), "table_2.jpg", "weiß",
				"Focus in weiß mit eingebauten Schubladen. Der Focus-Tisch hat ein effizientes Schubladendesign für mehr Produktivität und Ordnung. Er eignet sich hervorragend als Arbeitstisch.", moebelSupplier, 20, Category.TABLE));

		items.add(new Piece(31, "Designer", Money.of(449.99, Currencies.EURO), "table_3.jpg", "massiv wildeiche",
				"Designer mit massiver Wildeiche. Der Designer-Tisch bietet eine modische alternative zu herkömmlichen Tischen. Durch seine massive Bauart wird er zum Mittelpunkt des Raumes.", moebelSupplier, 50, Category.TABLE));

		items.add(new Piece(32, "Vintage", Money.of(369.99, Currencies.EURO), "table_4.jpg", "Glas",
				"Vintage mit Glasplatte. Der Vintage-Tisch bietet viel Platz und wirkt durch seine runde Glasplatte einladend.", moebelSupplier, 45, Category.TABLE));

		items.add(new Piece(33, "Oldtimer", Money.of(579.99, Currencies.EURO), "table_5.jpg", "Walnuss",
				"Oldtimer aus Walnussholz. Der Oldtimer-Tisch ist ein großer Familientisch und bietet Platz für 8 Personen.", moebelSupplier, 40, Category.TABLE));

		items.add(new Piece(34, "Ceramic", Money.of(269.99, Currencies.EURO), "table_6.jpg", "weiße Keramik",
				"Ceramic mit weißer Keramikplatte. Der Ceramic-Tisch ist ein flacher stylischer Tisch fürs Wohnzimmer.", moebelSupplier, 15, Category.TABLE));

		items.add(new Piece(36, "Exquisite", Money.of(629.99, Currencies.EURO), "table_8.jpg", "Ahorn",
				"Exquisite mit Ahornholz. Der Exquisite-Tisch ist ein großer hochwertiger Tisch mit Platz für 6 Personen.", moebelSupplier, 25, Category.TABLE));
		...
		items.add(new Set(41, "Küchen-Set-1", Money.of(119.99, Currencies.EURO), "set_2.jpg", "schwarz",
				"Set bestehend aus 2xBasic-Stuhl(schwarz) und 1xBasicPlus-Tisch.", setSupplier, Arrays.asList(chair_10_black,chair_10_black, table_9)));

		items.add(new Set(41, "Küchen-Set-2", Money.of(139.99, Currencies.EURO), "set_3.jpg", "weiß",
				"Set bestehend aus 3xBasic-Stuhl(weiß) und 1xBasic-Tisch.", setSupplier, Arrays.asList(chair_10_white, chair_10_white, chair_10_white, table_7)));
